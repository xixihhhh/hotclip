...
- **clips.json 处理回执**:每条片 AI 动了什么(字幕样式/取景模式/跳剪比例/对齐覆盖/字幕质检/封面选择模式与得分/剪了几个口头禅)一目了然,可审计,矩阵管线直接取用
...
| v0.18 ~ v0.25(质量评测 · 字幕质量门 · 多模态/屏显文字证据 · 舒适竖屏构图 · 成片质检 · 智能画面校正 · HDR 安全转 SDR · 同轨分析 · 质量封面) | ✅ 已发布 |
