...
const api: HotClipApi = {
  ...
  detectHighlights: (transcript, llm, filePath, diarize, prefilter, vision) =>
    ipcRenderer.invoke("hotclip:detect-highlights", transcript, llm, filePath, diarize, prefilter, vision),
