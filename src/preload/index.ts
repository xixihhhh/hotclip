...
const api: HotClipApi = {
  ...
  detectHighlights: (transcript, llm, filePath, diarize, prefilter, vision, length, products) =>
    ipcRenderer.invoke("hotclip:detect-highlights", transcript, llm, filePath, diarize, prefilter, vision, length, products),
